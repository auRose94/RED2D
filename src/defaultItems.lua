...
local ItemTypes = {
    ...
    ammo_launcher_grenade = {
        ...
        description = "Let's hope the space station can deal with the explosives. These explosives have enough power to kill most organic life...  More is recommended for synthetics and bioengineered  lifeforms.",
        rect = {66, 131, 31, 19},
        image = ItemImage,
        price = 100,
        count = 4,
