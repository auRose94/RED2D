...
function module.load()
	...
	imgui.SetStyleColorV4(imgui.ImGuiCol_ChildBg, 0.28, 0.15, 0.26, 0.39)
	imgui.SetStyleColorV4(imgui.ImGuiCol_WindowBg, 0.23, 0.12, 0.28, 0.39)
	...
	imgui.SetStyleValue("ItemSpacing", 8, 2)
